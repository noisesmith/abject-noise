...
pub fn start_audio(server_name: ?[*:0]const u8, user_data: *c_void,
    process_callback: jack_cb_t, prep_callback: jack_prep_t) u8 {
    ...
    jack.jack_on_shutdown(client, jack_shutdown, null);
    // info
